...
go_thea(InFile,_OutFile,dig_tell) :-
	...
	dig_tell_all('http://localhost:8081',reasoner_kb,Response),print(Response),nl.
...
go_dig(KBName,Response) :-
	...
	dig_new_kb('http://localhost:8081',KBName,_Result),
	dig_tell_all('http://localhost:8081',KBName,Response),print(Response),nl.
